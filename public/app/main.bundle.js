...
var JarwisService = /** @class */ (function () {
    ...
    function JarwisService(http) {
        this.http = http;
        this.baseUrl = 'http://larva-register.herokuapp.com/api';
    }
...
var TokenService = /** @class */ (function () {
    ...
    */
    function TokenService() {
        this.iss = {
            login: 'http://larva-register.herokuapp.com/api/login',
            signup: 'http://larva-register.herokuapp.com/api/signup'
        };
    }
