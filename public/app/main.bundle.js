...
var RequestResetComponent = /** @class */ (function () {
    function RequestResetComponent(Jarwis, notify, Notify) {
        this.Jarwis = Jarwis;
        this.notify = notify;
        this.Notify = Notify;
        this.form = {
    ...
    RequestResetComponent.prototype.onSubmit = function () {
        ...
        this.Jarwis.setPasswordResetLink(this.form).subscribe(function (data) { return _this.handleResponse(data); }, function (error) { return _this.notify.error(error.error.error); });
    };
...
var JarwisService = /** @class */ (function () {
    function JarwisService(http) {
        this.http = http;
        this.baseUrl = 'https://larva-register.herokuapp.com/api';
    }
    ...
    JarwisService.prototype.setPasswordResetLink = function (data) {
...
var TokenService = /** @class */ (function () {
    function TokenService() {
        this.iss = {
            login: 'https://larva-register.herokuapp.com/api/login',
            signup: 'https://larva-register.herokuapp.com/api/signup'
        };
    }
    ...
    TokenService.prototype.isValid = function () {
        ...
        // jeśli nie ma tokena zwracamy false
        return false;
    };
